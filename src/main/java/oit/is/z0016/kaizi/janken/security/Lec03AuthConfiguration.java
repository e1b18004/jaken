package oit.is.z0016.kaizi.janken.security;
...
public class Lec03AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("いしだ").password(passwordEncoder().encode("pAssw0rd")).roles("USER");
    auth.inMemoryAuthentication().withUser("きょうや").password(passwordEncoder().encode("pAssw0rd")).roles("USER");
